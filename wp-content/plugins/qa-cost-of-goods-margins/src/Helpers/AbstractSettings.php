		...
		foreach ( $options as $value ) {
			...
			switch ( $value['type'] ) {
                ...
                case 'submit_button':
                    ?>
                    <p class="submit">
                        <input name="<?php echo esc_attr( $value['name'] ); ?>" class="button-primary <?php echo esc_attr( $value['class'] ); ?>" type="submit" value="<?php esc_attr_e( $value['display_text'], 'woocommerce' ); ?>" />
                        <?php  ?>
                    </p>
                    <?php
                    break;
